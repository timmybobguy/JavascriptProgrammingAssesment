var addPoolResults = function (theTournament) {
  ...
  aSport.addPoolResult('Australia', 'Janacia', 71, 51)
  ...
  aSport.addPoolResult('Janacia', 'Fiji', 88, 30)
  ...
  aSport.addPoolResult('New Zealand', 'England', 64, 51)
  ...
  aSport.addPoolResult('England', 'Malawi', 54, 52)
  aSport.addPoolResult('England', 'Scotland', 57, 37)
  aSport.addPoolResult('England', 'Wales', 76, 40)
  ...
  aSport.addPoolResult('Wales', 'England', 31, 5)
  ...
  aSport.addPoolResult('Fiji', 'England', 54, 0)
  ...
  aSport.addPoolResult('England', 'Sri Lanka', 33, 10)
